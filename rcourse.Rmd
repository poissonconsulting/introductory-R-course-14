...
```{r, echo = FALSE, results = 'asis'}
exercise("Run the line of code above and then open the ToothGrowthMissing csv file in a spreadsheet program and replace the first five values in the `len` column with `NA`. Now use the `read.csv` function to import the ToothGrowthMissing csv file into the workspace. Use the `na.omit` function to delete the 
